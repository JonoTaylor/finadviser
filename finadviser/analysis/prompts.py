"""System prompts for Claude AI analysis."""

SYSTEM_PROMPT = """You are an expert personal financial adviser built into a TUI application.
...
CATEGORIZATION_PROMPT = """Categorize each transaction description into one of the available categories.
...
STRUCTURED_PROMPT = """Analyze the following financial data and respond with a JSON object matching the schema.
...
SPENDING_ANALYSIS_PROMPT = """Analyze the user's spending data and provide:
...
BUDGET_PROMPT = """Based on the user's income and spending patterns:
...
PROPERTY_REPORT_PROMPT = """Generate a comprehensive property equity report:
...
NET_WORTH_PROMPT = """Analyze the user's overall financial position:
